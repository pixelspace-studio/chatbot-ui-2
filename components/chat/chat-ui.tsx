...
export const ChatUI: FC<ChatUIProps> = ({}) => {
  ...
  return (
    <div className="relative flex h-[calc(100dvh)] flex-col items-center">
      ...
      <div
        className={`flex w-full flex-col overflow-auto overflow-x-hidden ${isCollapsed ? "pl-6" : ""}`}
      ...
      <div
        className={`relative w-full px-11 pb-8 pt-5 sm:w-[540px] md:w-[640px] lg:w-[740px] xl:w-[800px] ${isCollapsed ? "ml-6" : ""}`}
      >
        <ChatInput />
      </div>
